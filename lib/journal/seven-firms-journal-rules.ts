...
const FUNDED_CSV: Record<string, FundedCsv> = {
  ...
  // —— Aqua Futures ——
  "Aqua Futures|Aqua Futures One Step Beginner|25k": {
    overnight: "No",
    tradingNews: "No",
    sizing: "1 mini / 10 micros",
    drawdownType: "EOD",
    maxDrawdownUsd: 1000,
    dllCsv: "$600",
    payoutRules: formatPayoutRulesConsistency("40%"),
    payoutMiniUsd: 250,
    payoutMax: formatUsdWholeGrouped(750),
    profitSplit: "100% puis 90% après $15,000",
    bufferUsd: null,
  },
  "Aqua Futures|Aqua Futures One Step Beginner|50k": {
    overnight: "No",
    tradingNews: "No",
    sizing: "3 minis / 30 micros",
    drawdownType: "EOD",
  ...
  "Aqua Futures|Aqua Futures One Step Beginner|100k": {
    overnight: "No",
    tradingNews: "No",
  ...
  // —— Legends Trading ——
  "Legends Trading|Legends Trading Apprentice|50k": {
    overnight: "No",
    tradingNews: "No",
    sizing: "2 minis / 20 micros",
    drawdownType: "EOD",
    maxDrawdownUsd: 2000,
    dllCsv: "-",
    payoutRules: formatPayoutRulesConsistency("35%"),
    payoutMiniUsd: 1000,
    payoutMax: formatUsdWholeGrouped(1200),
    profitSplit: "90%",
    bufferUsd: 2000,
  },
  "Legends Trading|Legends Trading Elite|50k": {
    overnight: "No",
    tradingNews: "No",
    sizing: "4 minis / 40 micros",
    drawdownType: "EOD",
  ...
  "Legends Trading|Legends Trading Elite|100k": {
    overnight: "No",
    tradingNews: "No",
  ...
  "YRM Prop|YRM Prop Prime|25k": {
    ...
    payoutRules: formatPayoutRulesConsistency("35%"),
    payoutMiniUsd: 250,
    payoutMax: ["1st: $1,000", "2nd: $1,500", "3rd: $2,000", "4th+: $2,500"].join("\n"),
    profitSplit: "90%",
    bufferUsd: 100,
  },
  "YRM Prop|YRM Prop Prime|50k": {
    overnight: "No",
    tradingNews: "Yes",
    sizing: "5 minis / 50 micros",
    drawdownType: "EOD",
    ...
    payoutRules: formatPayoutRulesConsistency("35%"),
    payoutMiniUsd: 250,
    payoutMax: ["1st: $1,500", "2nd: $2,000", "3rd: $2,500", "4th+: $4,000"].join("\n"),
    profitSplit: "90%",
    bufferUsd: 100,
  },
  "YRM Prop|YRM Prop Prime|100k": {
    overnight: "No",
    tradingNews: "Yes",
    sizing: "10 minis / 100 micros",
    drawdownType: "EOD",
    ...
    payoutRules: formatPayoutRulesConsistency("35%"),
    payoutMiniUsd: 250,
    payoutMax: ["1st: $2,000", "2nd: $2,500", "3rd: $3,000", "4th+: $5,000"].join("\n"),
    profitSplit: "90%",
    bufferUsd: 100,
  },
  // —— Alpha Futures ——
  "Alpha Futures|Alpha Futures Zero|25k": {
    overnight: "No",
    tradingNews: "No",
    sizing: "1 mini / 10 micros",
    drawdownType: "EOD",
    ...
    profitSplit: "90%",
    bufferUsd: null,
    notes: "Demander 50% du solde ; 50% restent en buffer.",
  },
  "Alpha Futures|Alpha Futures Standard|50k": {
    overnight: "No",
    tradingNews: "No",
    sizing: "5 minis / 50 micros",
    drawdownType: "EOD",
    ...
    payoutRules: formatPayoutRulesConsistency("40%"),
    payoutMiniUsd: 200,
    payoutMax: formatUsdWholeGrouped(15000),
    profitSplit: "70% (1-2), 80% (3-4), 90% (5+)",
    bufferUsd: null,
  },
  "Alpha Futures|Alpha Futures Advanced|100k": {
    overnight: "No",
    tradingNews: "Yes",
    sizing: "10 minis / 100 micros",
    drawdownType: "EOD",
  ...
  // —— FuturesElite ——
  "FuturesElite|FuturesElite Prime|50k": {
    overnight: "No",
    tradingNews: "No",
    sizing: "3 minis / 30 micros",
    drawdownType: "Trailing",
    ...
    payoutRules: formatPayoutRulesConsistency("40%"),
    payoutMiniUsd: -1,
    payoutMax: ["1st: $1,300", "2nd: $1,500", "3rd+: $1,800"].join("\n"),
    profitSplit: "80%",
    bufferUsd: 2000,
    notes: "Demander 50% du solde ; 50% restent en buffer.",
  },
  "FuturesElite|FuturesElite Prime|100k": {
    overnight: "No",
    tradingNews: "No",
    sizing: "8 minis / 80 micros",
    drawdownType: "Trailing",
    ...
    payoutRules: formatPayoutRulesConsistency("40%"),
    payoutMiniUsd: -1,
    payoutMax: ["1st: $2,500", "2nd: $2,900", "3rd+: $3,300"].join("\n"),
    profitSplit: "80%",
    bufferUsd: 2800,
    notes: "Demander 50% du solde ; 50% restent en buffer.",
  },
  "FuturesElite|FuturesElite Elite|150k": {
    overnight: "No",
    tradingNews: "No",
    ...
    maxDrawdownUsd: 4500,
    dllCsv: "-",
    payoutRules: "5 min trading day(s)",
    payoutMiniUsd: -1,
    payoutMax: ["1st: $3,500", "2nd: $3,900", "3rd+: $3,900"].join("\n"),
    profitSplit: "80%",
    bufferUsd: 4500,
  },
};
